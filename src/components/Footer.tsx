        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li><Link href="/products?cat=ac" prefetch className="hover:text-foreground transition-colors">Air Conditioners</Link></li>
              <li><Link href="/products?cat=refrigerator" prefetch className="hover:text-foreground transition-colors">Refrigerators</Link></li>
              <li><Link href="/products?cat=led-tv" prefetch className="hover:text-foreground transition-colors">LED TVs</Link></li>
              <li><Link href="/products" prefetch className="hover:text-foreground transition-colors">All Products</Link></li>
            </ul>
          </div>
          <div>
            <h4 className="text-meta mb-3">Services</h4>
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li><Link href="/services" prefetch className="hover:text-foreground transition-colors">Repair & Maintenance</Link></li>
              <li><Link href="/services" prefetch className="hover:text-foreground transition-colors">Smart Home Setup</Link></li>
              <li><Link href="/services" prefetch className="hover:text-foreground transition-colors">Technical Support</Link></li>
            </ul>
          </div>
          <div>
            <h4 className="text-meta mb-3">Company</h4>
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li><Link href="/about" prefetch className="hover:text-foreground transition-colors">About Us</Link></li>
              <li><Link href="/reviews" prefetch className="hover:text-foreground transition-colors">Reviews</Link></li>
              <li><Link href="/contact" prefetch className="hover:text-foreground transition-colors">Contact Us</Link></li>
              <li><Link href="/admin" prefetch className="hover:text-foreground transition-colors">Admin Portal</Link></li>
            </ul>
          </div>
          <div>
